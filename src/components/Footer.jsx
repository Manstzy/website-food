  ...
  return (
    <div id="about" className="absolute right-0 left-0">
      <div className="bg-[#FFEFEC] w-full flex items-center justify-center py-10 ">
        <div className="flex laptop:flex-row laptop:gap-28 desktop:gap-52 flex-col items-center justify-center">
          <div>
          ...
          <div className="flex px-2 desktop:w-96 py-1 justify-between border-none bg-white rounded-full">
            <input
              type="text"
      ...
      <div className="bg-black py-5 px-5 laptop:flex laptop:justify-center">
        <div>
          ...
          <p className="text-white hidden laptop:mt-36 laptop:block">
        ...
        <p className="text-white text-center laptop:hidden">
          &copy; pizza. All right reserved
        </p>
      </div>
    </div>
