      ...
      <div className="tablet:flex tablet:justify-between">
        <div>
          <h1
            ...
            className="font-[800] large:mt-10 desktop:text-[45px] max-w-[380px] desktop:max-w-[500px] text-4xl font-inter desktop:mt-12"
          >
          ...
          <p
            ...
            data-aos-offset="500"
            data-aos-duration="500"
            className="font-poppins text-slate-500 large:mt-5 desktop:max-w-[400px] large:max-w-[350px] max-w-[300px] mt-10"
          >
          ...
          <div
            ...
            data-aos-offset="500"
            data-aos-duration="500"
            className="flex px-2 py-1 mt-20 desktop:max-w-[400px] desktop:mt-8 large:mt-2 large:w-96 max-w-[350px] justify-between border-none bg-slate-200 rounded-full"
          >
            <input
              type="text"
          ...
          <div className="flex gap-3 mt-5 large:mt-0 desktop:gap-10">
            <div
              ...
              data-aos-offset="500"
              data-aos-duration="500"
              className="flex items-center border-none rounded-md w-40 mt-10 p-2 bg-gray-200"
            >
        ...
        <div
          ...
          data-aos-offset="500"
          data-aos-duration="500"
          className="bg-[#F2EBDA] hidden mt-10 desktop:h-[340px] desktop:w-[420px] h-[300px] tablet:flex laptop:py-4 laptop:w-[360px] items-center justify-center rounded-xl"
        >
          <img
            src={Images}
